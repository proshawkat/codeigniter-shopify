<div style="width: 100%; background-color: #EEEEEE; min-height: 300px; margin: 0; padding: 50px 0; font-family: sans-serif; color: #444;">
    <div style="width: 100%; max-width: 768px; min-height: 300px; margin: 0 auto;">
        ...
        <div style="height: 70px;">
            <div style="width: 50%; float: left; font-size: 35px; font-weight: bold; font-family: sans-serif;"><?php echo WEBSITE_NAME;?></div>
        ...
        <div style="background-color: #FFFFFF; min-height: 350px; border-top: 15px solid #ec77d3; padding: 30px;">
            <h1 style="font-size: 25px; font-weight: normal;">Welcome to <?php echo $event_name;?></h1>
            <h3>Hello <?php echo $name;?></h3>
            <p>Below is your event information</p>

            <p style="border: 2px dotted #CCC; padding: 30px; font-size: 18px; color: #555;">Event will start at: <span style="color: #ec77d3; font-weight: bold; letter-spacing: 2px;"><?php echo format_date($event_start_date);?>, <?php echo date("h:i a", strtotime($event_start_time));?> (<?php echo $event_time_zone;?>)</span></p>

            <p style="font-size: 20px;">To join the event visit the event page.</p>
            <a href="<?php echo (isset($guest_url)) ? $guest_url: '';?>" target="_blank" style="display: block; margin: 0 auto; text-align: center; text-decoration: none; color: #FFF; width: 200px; height: 50px; background-color: #222; line-height: 50px; font-size: 20px;">Visit Event Page</a>
        </div>

        <!-- Mail footer -->
        <div style="height: auto;background-color:#d6dad2; padding: 0 30px 30px;">
            ...
            <div style="font-size: 35px; font-weight: bold; font-family: sans-serif;"><?php echo WEBSITE_NAME;?></div>
