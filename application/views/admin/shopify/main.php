                ...
                <div class="Polaris-Page-Header Polaris-Page-Header--hasNavigation Polaris-Page-Header--hasActionMenu Polaris-Page-Header--mobileView Polaris-Page-Header--mediumTitle">
                    <div class="Polaris-Page-Header__Row">
                        ...
                        <div class="Polaris-Page-Header__RightAlign">
                            <a class="Polaris-Link" target="_blank" href="https://fogzee.com/contact-us/" data-polaris-unstyled="true">Get Support</a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="Polaris-Card__Section">
                                        <div class="Polaris-SettingAction">
                                            ...
                                            <div class="Polaris-SettingAction__Action">
                                                <?php if($shop_domain != ""){ ?>
                                                <button class="Polaris-Button Polaris-Button--primary account-connection-modal-btn" type="button">
                                                    <span class="Polaris-Button__Content"><span class="Polaris-Button__Text">Connect</span></span>
                                                </button>
                                                <?php }else{ ?>
                                                    <div><span class="Polaris-TextStyle--variationSubdued">Shop domain not found.</span></div>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
...
<div>
    ...
    <input type="hidden" name="store_domain" id="store_domain" value="<?php echo $shop_domain;?>">
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".account-connection-modal-btn").click(function () {
                var store_domain = $("#store_domain").val();
                var win = popupwindow("<?php echo base_url();?>login?shop=" + store_domain, 'targetWindow', '480', '600');
                var timer = setInterval(function() {
                    if(win.closed) {
                        clearInterval(timer);
                        parent.location.href = "https://" + store_domain + "/admin/apps/<?php echo MY_APP_NAME;?>";
                    }
                }, 1000);
            });
        });
